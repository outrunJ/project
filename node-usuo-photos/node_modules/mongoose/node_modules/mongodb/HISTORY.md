...
* Added socketTimeoutMS and connectTimeoutMS to socket options for repl_set.js and serverConf.js
...
* Correctly emit errors from serverConf.js only wrapping errors that are strings
